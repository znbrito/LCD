...
int speed = 0; // variable to be used in lcd_write_speed_slow() and lcd_write_speed_normal() functions
...
static void lcd_write(uint8_t data,uint8_t rs)
  {
	if(speed == 1)
	{
		Delay_us(80000); // uncomment this line for you to see what's being written in the LCD display slowly. You can change the velocity by changing the delay value
	}
...
/*************************************************************************
Turn ON the LCD blinking cursor
Input:    none
Returns:  none
*************************************************************************/
...
/*************************************************************************
Turn ON the LCD underline cursor
Input:    none
Returns:  none
*************************************************************************/
...
/*************************************************************************
Turn ON the LCD underline and blinking cursor
Input:    none
Returns:  none
*************************************************************************/
void lcd_underline_blink_cursor()
  {
	lcd_command(_BV(LCD_DISPLAYMODE) | _BV(LCD_DISPLAYMODE_ON) | _BV(LCD_DISPLAYMODE_CURSOR) | _BV(LCD_DISPLAYMODE_BLINK));
  }

/*************************************************************************
Turn OFF the LCD underline and blinking cursor
Input:    none
Returns:  none
*************************************************************************/
void lcd_no_cursor()
...
/*************************************************************************
Does a shift right to the cursor
Input:    none
Returns:  none
*************************************************************************/
...
/*************************************************************************
Does a shift left to the cursor
Input:    none
Returns:  none
*************************************************************************/
...
/*************************************************************************
Does a shift right to the display
Input:    none
Returns:  none
*************************************************************************/
...
/*************************************************************************
Does a shift left to the display
Input:    none
Returns:  none
*************************************************************************/
...
/*************************************************************************
When called, future strings or chars are written backwards, from right to left instead of the usual left to right
Input:    none
Returns:  none
*************************************************************************/
void lcd_write_backwards()
  {
	lcd_command(_BV(LCD_ENTRY_MODE));
  }

/*************************************************************************
When called, future strings or chars are written normally, from right to left (default). Only call this function if you called function lcd_backwards() before!
Input:    none
Returns:  none
*************************************************************************/
void lcd_write_normally()
  {
	lcd_command(_BV(LCD_ENTRY_MODE) | _BV(LCD_ENTRY_INC));
  }

/*************************************************************************
When called, future strings or chars are written slower. You can change this "slow" by changing the delay value in line 397 of this document
Input:    none
Returns:  none
*************************************************************************/

void lcd_write_speed_slow()
  {
	speed = 1;
  }

/*************************************************************************
When called, future strings or chars are written instantaneously (default). Only can this function if you called lcd_write_speed_slow() before!
Input:    none
Returns:  none
*************************************************************************/

void lcd_write_speed_normal()
  {
	speed = 0;
  }
